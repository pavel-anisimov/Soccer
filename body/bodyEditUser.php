...
echo "<font size=2 color=000080>Add User</font></tr></tr></table><img src=images/null.png height=6></img></center>";
	...
	$result = mysql_query("SELECT * FROM users WHERE status='user' OR status='admin'");
...
while($requests = mysql_fetch_object($result)){
	...
	echo "<td>\n<input type='text' id='pass' name='regLogin' size=15 value='" . $requests->login . "'></td></tr>\n";
	
	echo "<tr><td align=right><font face=verdana size=2 color=000050>Password:</font></td> \n";
	echo "<td><input type='text' id='user' name='regPassword' size=15 value='" . $requests->password . "'></td></tr>\n";
	
	echo "<tr><td align=right><font face=verdana size=2 color=000050>Email:</font></td> \n";
	echo "<td><input type='text' id='user' name='regEmail' size=15 value='" . $requests->email . "'></td></tr>\n";

	echo "<tr><td align=right><font face=verdana size=2 color=000050>Nickname:</font></td> \n";
	echo "<td><input type='text' id='user' name='regNickname' size=15 value='" . $requests->nickname . "'></td></tr>\n";
